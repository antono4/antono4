...
<div align="center">
  <picture>
    <!-- Tampilan untuk pengguna GitHub Dark Mode (Menggunakan tema Cyberpunk!) -->
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/antono4/antono4/output/github-contribution-grid-snake-cyberpunk.svg">
    <!-- Tampilan untuk pengguna GitHub Light Mode (Standar) -->
